    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-slate-950">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center max-w-5xl mx-auto">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-slate-800/50 backdrop-blur-sm rounded-full border border-slate-700 shadow-sm mb-8">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold tracking-tight mb-8">
            <span className="block text-white mb-2">{title.split(' ').slice(0, 2).join(' ')}</span>
          ...
          {/* Tagline */}
          <p className="text-xl sm:text-2xl md:text-3xl font-medium text-slate-300 mb-6">
            {tagline}
          </p>

          {/* Description */}
          <p className="text-base sm:text-lg md:text-xl text-slate-400 mb-12 max-w-3xl mx-auto leading-relaxed">
            {description}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              ...
              className="group relative inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-2xl hover:shadow-blue-500/50 hover:scale-105 transition-all duration-200 overflow-hidden"
            >
            ...
            <a
              ...
              className="group inline-flex items-center gap-2 px-8 py-4 bg-transparent text-white font-semibold rounded-xl border-2 border-slate-700 hover:border-slate-500 shadow-sm hover:shadow-md transition-all duration-200 hover:bg-slate-800/50"
            >
              {cta.secondary.text}
              <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
